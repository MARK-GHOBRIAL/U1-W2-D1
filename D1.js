...
/*1)"string" per descrivere un testo
2)"number" per valori numerici
3)"boolean" per valori true & false
4)"Undefined" Rappresenta una variabile dichiarata ma non ancora inizializzata
5)"Null" rappresenta l'intensione di assegnare un valore nullo
*/
...
/* SCRIVI QUI LA TUA RISPOSTA */
let z = 4
let secondaSomma = z + x
console.log("la seconda somma e'" + " " + secondaSomma)
